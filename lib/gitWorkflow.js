...
export class GitWorkflow {
  ...
  async getStagedDeletedFiles() {
    ...
    debugLog('Found partially staged files:', stagedDeleted)
    return stagedDeleted.map((file) => path.resolve(this.topLevelDir, file))
  }
  ...
  async prepare(ctx, task) {
    try {
      ...
      this.stagedDeletedFiles = await this.getStagedDeletedFiles()
