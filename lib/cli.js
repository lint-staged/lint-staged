...
const CLI_OPTIONS = [
  ...
  },
  {
    ...
    type: 'boolean',
    description:
      'include all files tracked in Git instead of only staged (default: false). Implies "--no-stash" and "--allow-empty"',
  },
  {
    flag: 'allow-empty',
    type: 'boolean',
...
/** @type {(value: string | undefined) => number | boolean | undefined} */
...
export const parseCliOptions = (argv) => {
  ...
  return {
    ...
    concurrent: parseBoolOrNumber(values.concurrent),
    ...
    help: values.help,
    hidePartiallyStaged: values['hide-partially-staged'],
