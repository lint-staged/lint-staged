...
/**
 * Remore file or directory
 * @param {String} target
 * @param {Boolean} [ignoreENOENT=true] — Whether to throw if the target doesn't exist
 */
export const rm = async (target, ignoreENOENT = true) => {
  debugLog('Removing file or directory `%s`', target)
  await fs.rm(target, { recursive: true, force: ignoreENOENT })
}
