...
Options:
  ...
  -e, --escape                       escape special characters in filenames (default: false)
...
- **`--escape`**: Enable to to escape certain characters like brackets or spaces from filenames before passing them to tasks.
