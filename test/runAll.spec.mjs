...
jest.unstable_mockModule('../lib/resolveGitRepo.mjs', () => ({ resolveGitRepo: jest.fn() }))

const { execa } = await import('execa')
const { getStagedFiles } = await import('../lib/getStagedFiles.mjs')
const { GitWorkflow } = await import('../lib/gitWorkflow.mjs')
const { resolveGitRepo } = await import('../lib/resolveGitRepo.mjs')
const { runAll } = await import('../lib/runAll.mjs')
const { GitError } = await import('../lib/symbols.mjs')
